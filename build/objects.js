...
var consolidateTimeOrderedArray = function consolidateTimeOrderedArray(arr, _count, tsKey, keyTypes) {
    ...
    for (var key in keyTypes) {
      ...
      if (isPrimitiveNumber(d[key])) {
        ...
        if (typeof newDp[key] === 'undefined') {
          newDp[key] = aggType === 'mean' ? [d[key]] : d[key];
        } else {
          if (aggType === 'mean') {
...
var _diffObjectsInner = function _diffObjectsInner(o1, o2) {
  ...
  var o3 = {};
  if (type1 !== type2) {
    var o1Print = type1 === 'object' || type1 === 'array' ? ' ' + JSON.stringify(o1, null, 2) : type1 === 'null' || type1 === 'undefined' ? type1 : ' ' + o1;
    var o2Print = type2 === 'object' || type2 === 'array' ? ' ' + JSON.stringify(o2, null, 2) : type2 === 'null' || type2 === 'undefined' ? type2 : ' ' + o2;
    ...
    o3 = o1 === o2 ? o1 : '!DIFF! ' + o1 + ' vs ' + o2 + ' !DIFF!';
  }
  return o3;
};
...
module.exports = {
  ...
  consolidateTimeOrderedArray: consolidateTimeOrderedArray,
  // arrays
